    ...
    public static <I, O> List<O> transform(final Iterable<I> base, final Function<I, O> transformer) {
        return flattenTransform(base, new Function<I, Collection<O>>(){
            ...
            public Collection<O> call(I input) {
                final var singleElementCollection = new ArrayList<O>(); 
                singleElementCollection.add(transformer.call(input));
    ...
    public static <I> List<I> select(final Iterable<I> base, final Function<I, Boolean> test) {
        return flattenTransform(base, new Function<I,Collection<I>>() {
            ...
            public Collection<I> call(I input) {
                final var singleElementCollectionTested = new ArrayList<I>();
                if(test.call(input) == true){
                    singleElementCollectionTested.add(input);
                }
                return singleElementCollectionTested;
            }
        });
    }
